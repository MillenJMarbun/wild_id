...
class reptilelvl1 extends StatefulWidget {
  ...
  final int bestScore;
  reptilelvl1({Key key, @required this.bestScore}) : super(key: key);
}
...
class _reptilelvl1State extends State<reptilelvl1> {
  ...
  Widget build(BuildContext context) {
    ...
    final Questions = [
      ...
      Container(
        ...
        child: QuizView(
          ...
          width: 400,
          height: 700,
          question: "What is the maximum length that a Komodo Dragon can grow to?",
          rightAnswer: "3 metres",
          wrongAnswers: [
            "8 Metres",
            "2 Metres",
            "10 Metres"
      ...
      Container(
        ...
        child: QuizView(
          ...
          width: 400,
          height: 700,
          question: "How many eggs can a komodo dragon lay at a time?",
          rightAnswer: "20",
          wrongAnswers: [
            "65",
            "44",
      ...
      Container(
        ...
        child: QuizView(
          ...
          width: 400,
          height: 700,
          question: "How long can a borneo python reach up to?",
          rightAnswer: " 2.1 m",
          wrongAnswers: [
            "10 m",
            "5 m",
      ...
      Container(
        ...
        child: QuizView(
          ...
          width: 400,
          height: 700,
          question: "What is the King Cobra Diet?",
          rightAnswer: "All Corect",
          wrongAnswers: [
            "Other Snakes",
            "King Cobras",
            "Borneo"
      ...
      Container(
        ...
        child: QuizView(
          ...
          width: 400,
          height: 700,
          question: "What is this species shown in the picture above?",
          rightAnswer: "Sulawesi Turtles",
          wrongAnswers: [
            "Forest Tortoise",
            "Green Turtle",
            "Leatherback Turtle"
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text("Reptiles Level 1 Quiz",
          style:(
              GoogleFonts.sora(
                  textStyle: TextStyle(
                    color: Colors.white,
