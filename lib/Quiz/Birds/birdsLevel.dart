...
import 'package:wild_id/Quiz/Birds/birdlvl1.dart';
...
class birdsLevel extends StatefulWidget {
  @override
  _birdsLevelState createState() => _birdsLevelState();
}

class _birdsLevelState extends State<birdsLevel> {
  ...
  Widget build(BuildContext context)  {
    var _bestScore1 = loggedInUser.birdslvl1;
    var _bestScore2 = loggedInUser.birdslvl2;
    var _bestScore3 = loggedInUser.birdslvl3;
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      InkWell(
                        onTap: (){
                          Navigator.of(context).push(MaterialPageRoute(builder: (context)=>birdslvl1(bestScore: _bestScore1)));
                        },
                        child: Container(
                          height: 220,
                          child: Stack(
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: 7),
                                            Text(
                                              "Highest Score: ${loggedInUser.birdslvl1}",
                                              style: GoogleFonts.sora(
                                                  textStyle: TextStyle(
                                                    fontSize: 14,
                                                    color: mywhite,
                      ...
                      InkWell(
                        onTap: (){
                          if(loggedInUser.birdslvl1 > 79){
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>birdslvl2(bestScore : _bestScore2)));
                          }
                          else{
                            showDialog<String>(
                                context: context,
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: 7),
                                            Text(
                                              "Highest Score: ${loggedInUser.birdslvl2} ",
                                              style: GoogleFonts.sora(
                                                  textStyle: TextStyle(
                                                    fontSize: 14,
                                                    color: mywhite,
                      ...
                      InkWell(
                        onTap: (){
                          if(loggedInUser.birdslvl2 > 79){
                            Navigator.of(context).push(MaterialPageRoute(builder: (context)=>birdslvl3(bestScore : _bestScore3)));
                          }
                          else{
                            showDialog<String>(
                                context: context,
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            SizedBox(height: 7),
                                            Text(
                                              "Highest Score: ${loggedInUser.birdslvl3} ",
                                              style: GoogleFonts.sora(
                                                  textStyle: TextStyle(
                                                    fontSize: 14,
                                                    color: mywhite,
