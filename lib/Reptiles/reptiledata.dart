...
List<Reptiles> recentList = [
  Reptiles(
      ...
      "d2ccc4",
      loc:
      "Komodo, Rinca, Flores Islands"
  ),
  Reptiles(
      category: "Reptiles",
      title: "Borneo\nPython",
      image:
      "assets/Reptiles/borneopython.png",
      image2:
  ...
  Reptiles(
      ...
      title: "King\nCobra",
      image:
      "assets/Reptiles/kingcobra.png",
      image2:
      'assets/Reptiles/kingcobra2.jpg',
      subtitle:
      "The king cobra is a venomous snake species of elapids endemic to jungles Southeast Asia. The king cobra is the world's longest venomous snake,",
      description:
      "The king cobra is a venomous snake species of elapids endemic to jungles in Southern and Southeast Asia. The sole member of the genus Ophiophagus, it is distinguishable from other cobras, most noticeably by its size and neck patterns. The king cobra is the world's longest venomous snake, with an average length of 3.18 to 4 m, reaching a maximum of 5.85 m. Its skin colour varies across the habitats, from black with white stripes to unbroken brownish grey. It preys chiefly on other snakes, including its own species. Unlike other snakes, it rarely hunts non-reptile vertebrates, such as rodents and lizards.\nKing Cobra snake body length generally ranges from 3.18 to 4 meters. The longest specimen ever found was 5.85 meters long. Male snakes are larger than female snakes.\nThe upper body (dorsal) is olive, yellowish-brown, or grayish in color, with the head tending to be lighter in color. The lower part of the body (ventral) is gray or brown, with a yellowish neck area decorated with black spots. In young snakes, the body is darker or blackish in color, and is decorated with small white or yellowish stripes. Even so, the stripes are sometimes still visible as adults, although they are more subtle.\nThe head of the snake is large with a snout that tends to be short and blunt. Unlike other snakes in general, behind the pariental shield (scales) there is a pair of large occipital shields. There are 7 labial (lip) shields, some of which are in contact with the eyes. The pupils of the eyes are large and round. The dorsal scales consist of 15 rows in the middle of the body. The ventral scales are 215 to 262 pieces. Single anal scales, subcaudal scales as many as 80 to 120 pieces, some are single scales and some are paired scales.",
      habitat: "King Cobra snakes are widespread from parts of Indonesia (Sumatra, Mentawai Islands, Riau Islands, Bangka-Belitung, Java, Bali, Kalimantan, Sulawesi).\nKing Cobra snakes live in lowland areas up to an altitude of 1800 meters above sea level. Its main habitats include forests, swamps, bush areas, agricultural land, and even around settlements. These snakes usually nest in holes in the ground, piles of rocks, thick bushes, or between tree roots. This snake especially likes locations overgrown with bamboo and mangrove forest areas.",
      diet: "King Cobra snakes is a snake that is well known as a predator of other snakes, including snakes that are also venomous. Snake species known to be the main prey for this snake include the Indian cobra, krait, rat snake, Rhabdophis, wolf snake, and even small pythons. In addition to other snakes, snakes also prey on types of lizards, rodents, and birds. After eating large prey, this snake can survive without eating again for several months. This is because of his slow metabolism",
      color:
      "766a65",
      color2:
      "edd812",
  ...
  Reptiles(
      ...
      title: "Sulawesi\nTurtles",
      image:
      "assets/Reptiles/sulawesiturtle.png",
      image2:
      'assets/Reptiles/sulawesiturtle2.jpg',
      subtitle:
      "The Sulawesi forest turtle is a critically endangered species of turtle in the family Geoemydidae. It is endemic to Sulawesi in Indonesia.",
      description:
      "The Sulawesi Forest Turtle (Leucocephalon yuwonoi) is a critically endangered reptile species in Indonesia. The reptile abounds only in the Sulawesi in Indonesia. The turtle is characterized by a flat brown carapace. The female’s head appears as dark brown with parts of yellow while the male’s head is entirely yellow. The male grows to 28 centimeters, while females are smaller at 24 centimeters. The turtle inhabits both land and water and blends well with the environment. The turtles’ population has been on a decline in Sulawesi due to capture by humans for delicacy and trade. There is yet to be a major conservation initiative for the turtle.\nLeucocephalon yuwonoi (Family Geoemydidae), is one of the world's most mysterious and little-known turtles. There are some observations from the wild and its life history remains unstudied. This species is a medium sized (carapace length up to 278 mm), semi-aquatic omnivorous tortoise, which lays one or sometimes two large eggs in each clutch. First purchased from locals in Gorontalo in northern Sulawesi during the late 1980s, large numbers emerged in the commercial sea turtle trade to China in the early 1990s, and the species was officially described in 1995. The species is endemic to the island of Sulawesi (formerly known as as Celebes), Indonesia, and is believed to be confined to the provinces of Central Sulawesi, Gorontalo, and North.",
      habitat: "The sulawesi forest turtle can be found in forests inside of sulawesi, the turtle inhabits both land and water and blends well with the environment. ",
      diet: "The sulawesi forest turtle eats a wide variety of foods, including strawberries, bananas, green leafy vegetables, figs, cranberries, pumpkin, earthworms, dead rats, carp, shrimp and commercial turtle & tortoise mixes.",
      color:
      "96705b",
      color2:
      "ba9a8e",
  ...
  Reptiles(
      ...
      image2:
      'assets/Reptiles/forstentortoise2.jpg',
      subtitle:
      "Forsten's tortoise is a species of tortoise in the family Testudinidae. Forsten's tortoise is one of three tortoise species placed in the genus Indotestudo.",
      description:
      ...
      habitat: "Indotestudo forsteni can be found on Sulawesi Island of Indonesia, and its nearby islands such as Halmahera island. In Sulawesi, it is found in the central and northern parts of the island.\nIn North Sulawesi, it is found in Mount Boliahutu and around Buol, while in Central Sulawesi, it is found in Santigi, Morowali Reserve, Palu Valley, Kulawi Valley, Bora Village near Gimpu, and along the western border of Lore Lindu National Park.",
      diet: " In regards to diet, the tortoise is omnivorous and feeds on carrion, leafy greens, worms, fruits and slugs.",
      color:
      "d99058",
      color2:
      "000000",
  ...
  Reptiles(
      ...
      title: "BlueTounge\nSkink",
      image:
      "assets/Reptiles/bluetongue.png",
      image2:
      'assets/Reptiles/bluetongue2.jpg',
      subtitle:
      "The Blue Tongue Skink is a group of fat-bodied bengkarung that has the characteristic feature of blue or indigo tongue. These lizards are widespread in the Maluku islands, Papua, to Australia.",
      description:
      "All types of this genus have a solid body but somewhat flattened. The body is mottled brown or gray and dark, except for Tiliqua nigrolutea and Tiliqua rugosa. As the name implies, these lizards have broad tongues and are dark blue or bluish black in color. This lizard will stick out its tongue if disturbed, with the intention that the intruder thinks that this lizard is poisonous and then leaves it. These lizards move quite slowly compared to other types of lizards. These lizards like insects, small arachnids, vegetables, and fruits as food. Almost all species are distributed in Australia, except for Tiliqua gigas which is only found in Maluku and Papua. These lizards reproduce by laying eggs in their stomachs and giving birth (Ovoviviparous). These lizards usually give birth to as many as 5-10 tails, the number of children of each species is different. The eggs will hatch in the stomach after incubation between 3 to 5 months. The length of the newly hatched young lizard reaches about 13 cm.\n Indonesian Blue Tongue Skinks are 15-30” long (38-76 centimeters) and weigh around 700 grams. They are typically smaller than Northerns. All blue-tongued skinks have long bodies, short, thick tails, short legs, triangular heads, and of course blue tongues. Tanimbars are silver, grey, or yellow in color, with hard and glossy scales. Classic Indonesians are distinguished by their green or yellowish coloring, solid black forelimbs, speckling between bands, and thin black head markings. Meraukes have a salmon or orange-colored belly, freckling on their arms, and distinct banding typically without freckling in between the bands. Irian Jayas have speckled forearms, brown banding, and minimal speckling in between the bands. Kei Island BTS have unique freckles from their head down their back.\nBlue-tongued skinks are fairly large lizards, reaching 18 to 20 inches in length. They have long, solid bodies, triangular-shaped heads and comparatively small legs. The tail is slightly shorter than the length of the body and tapers to a point. There are several species of blue-tongued skinks inhabiting Australia and Indonesia, which all differ slightly in appearance. Indonesian blue-tongued skinks vary in color among individuals but are generally grey or pale brown with irregular dark brown or black bands across the back and tail. Their legs are mostly black with small specks of white. They are also equipped with a blue tongue.\n\nUnlike most reptile species, these skinks do not lay eggs. Instead they are ovoviviparous, meaning they give birth to live young encased in membranous sacs. Mating occurs in the spring months. Gestation lasts three to four months and results in five to 15 young. Neonates are able to feed on their own after birth and are reared quickly.",
      habitat: "Indonesian blue-tongued skinks live in arid grasslands and dry sclerophyll forests. Their short legs do not allow them to climb easily, so they spend the vast majority of their time on the ground hiding in the brush or in shallow burrows carved by their shovel-like snouts. They are diurnal (active during the daytime) and they generally find cover to rest under at night. Even though skinks have very sturdy, solid tails, they can release them like some other lizard species. This is used as a defense mechanism when necessary. Their tails will heal over, sometimes growing back, but never reform exactly like the original. Blue-tongued skinks may also display their blue tongue when threatened.",
      diet: "Blue-tongued skinks are omnivorous, eating both animal and plant matter. In the wild, they eat fruit, insects, mollusks and carrion. At Happy Hollow, they are fed fruits, vegetables and insects.\n\nMost species are diurnal, ground-foraging omnivores, feeding on a wide variety of insects, gastropods, flowers, fruits and berries. The pygmy blue-tongue is again the exception, being primarily an ambush predator of terrestrial arthropods. All are viviparous, with litter sizes ranging from 1-4 in the pygmy blue-tongue and shingleback to 5-24 in the eastern and northern blue-tongues.",
      color:
      "fc575e",
      color2:
      "90d5ec",
  ...
  Reptiles(
      ...
      title: "Tree\nMonitor",
      image:
      "assets/Reptiles/treemonitor.png",
      image2:
      'assets/Reptiles/treemonitor2.jpg',
      subtitle:
      "The Spotted Tree Monitor or Varanus timorensis, is a species of small monitor lizards found in Indonesia, specifically the islands of Timor, Savu, and Rote,",
      description:
      ...
      habitat: "The Timor monitor is found in Indonesia, specifically the islands of Timor, Savu, and Rote. The Varanus timorensis live in hollowed trees and branches, the spotted coloration helps them camouflage into the surrounding habitats.",
      diet: "King Cobra snakes is a snake that is well known as a predator of other snakes, including snakes that are also venomous. Snake species known to be the main prey for this snake include the Indian cobra, krait, rat snake, Rhabdophis, wolf snake, and even small pythons. In addition to other snakes, snakes also prey on types of lizards, rodents, and birds. After eating large prey, this snake can survive without eating again for several months. This is because of his slow metabolism",
      color:
      "756213",
      color2:
  ...
  Reptiles(
      ...
      title: "Earless\nMonitor",
      image:
      "assets/Reptiles/earlesslizard.png",
      image2:
